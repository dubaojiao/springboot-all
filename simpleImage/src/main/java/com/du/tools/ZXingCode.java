...
public class ZXingCode {
    ...
    public static void main(String[] args) throws WriterException {
        /*File logoFile = new File("D://test/p.png");
        File QrCodeFile = new File("D://test/05.png");
    ...
    // 生成带logo的二维码图片
    public static BufferedImage drawQRCode(String text) throws Exception {
        try {
    ...
    // 生成带logo的二维码图片
    public static InputStream drawLogoQRCode(String logoPath, String text, String note) throws Exception {
        try {
            File logoFile = new File(logoPath);
            if (!logoFile.exists()) {
                throw new Exception("login图片不存在");
            }
    ...
    // 生成带logo的二维码图片
    public static BufferedImage drawLogoQRCodeRetBuffer(String logoPath, String text, String note) throws Exception {
        try {
            File logoFile = new File(logoPath);
            if (!logoFile.exists()) {
                throw new Exception("login图片不存在");
